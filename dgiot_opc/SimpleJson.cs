...
namespace shuwa_opc
{
 ...
 static class SimpleJson
    {
        ...
        public static object DeserializeObject(string json, Type type, IJsonSerializerStrategy jsonSerializerStrategy)
        {
            ...
            return type == null || jsonObject != null && Reflection.ReflectionUtils.IsAssignableFrom(jsonObject.GetType(), type)
                       ? jsonObject
 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        internal IDictionary<Type, Reflection.ReflectionUtils.ConstructorDelegate> ConstructorCache;
        internal IDictionary<Type, IDictionary<string, Reflection.ReflectionUtils.GetDelegate>> GetCache;
